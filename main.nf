...
workflow {
    ...
    noxWorkflow(params.experiment_annotation_fp,
		...
		params.reduce_to_labels.toInteger(),
		params.drop_samples,
		params.quantile_threshold.toFloat(),
		params.min_peptide_count.toInteger(),
		params.peptide_missingness_cutoff.toFloat(),
		params.normalize.toInteger(),
		params.normalize_peptide.toInteger(),
		params.normalize_protein.toIntger(),
		params.impute.toInteger(),
		params.impute_protein.toInteger(),
		params.filter_cv.toInteger(),
		params.gaf_filename,
		params.obo_filename
	)
}
